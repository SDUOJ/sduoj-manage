<template>
  <div>
    ...
    <!-- 表单 -->
    <el-form :model="problemProfile" :rules="problemProfileRules" ref="problemProfile" style="margin-top: 20px">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      checkpoint() {
        this.$router.push({name: 'checkpoint', params: {pid: this.problemId}})
      },
