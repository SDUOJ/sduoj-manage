    ...
    <div class="checkpointtable">
      <div class="clearfix">
        ...
        <div style="float: right">
          <Button icon="md-download" type="primary" :loading="downloadLoading" @click="onDownload(selectedCheckpoints)">Downloads</Button>
        </div>
      </div>
      ...
      <Table
        ...
        <template slot-scope="{ row }" slot="actions">
          <Button size="small" icon="md-download" type="primary" :loading="downloadLoading" @click="onDownload([row.checkpointId])" />
          <Poptip
            confirm
...
<script>
import CheckpointsUpload from './CheckpointsUpload';
import CheckpointPreview from './CheckpointPreview';
import api from '_u/api';

export default {
  name: 'CheckpointList',
  components: { CheckpointsUpload, CheckpointPreview },
  data: function() {
    return {
      totalColumns: [
        {
  ...
  computed: {
    ...
    checkpointHasChanged: function() {
      return this.totalCheckpoints !== this.originalTableData;
    }
  },
  methods: {
